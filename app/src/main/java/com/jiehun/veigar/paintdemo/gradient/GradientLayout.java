package com.jiehun.veigar.paintdemo.gradient;
...
//        mPaint.getFontMetrics(); //获取字体度量对象
    ...
    protected void onDraw(Canvas canvas) {
         ...
         */
        //mShader = new LinearGradient(0,0,500,500,new int[]{Color.RED, Color.BLUE, Color.GREEN},null,Shader.TileMode.REPEAT);
         ...
         */
//        mShader = new RadialGradient(250, 250, 250, new int[]{Color.GREEN, Color.YELLOW, Color.RED}, new float[]{0f,0.5f,1f}, Shader.TileMode.CLAMP);
//        mPaint.setShader(mShader);
//        canvas.drawCircle(250, 250, 250, mPaint);
         ...
         */
        //顺时针
//        mShader = new SweepGradient(500, 500, Color.RED, Color.GREEN);
//        mPaint.setShader(mShader);
